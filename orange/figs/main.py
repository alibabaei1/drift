...
def histo1(Energy):
    plt.xlabel('Energie')
    plt.ylabel('Anzahl')
    plt.title('#=50000, bin=30, Energy=5.4 ')
    plt.grid(True)
    n, bins, patches = plt.hist(random_End_Energy(Energy,50000), 30, density=False, facecolor='g', alpha=0.75)
    plt.savefig('5-4MeV_2.png')
def histo2(Energy):
    plt.xlabel('Energie')
    plt.ylabel('Anzahl')
    plt.grid(True)
    plt.title('#=50000, bin=30, Energy=4 ')
    n, bins, patches = plt.hist(random_End_Energy(Energy,50000), 30, density=False, facecolor='g', alpha=0.75)
...
def histo3(Energy):
    ...
    plt.ylabel('Anzahl')
    plt.grid(True)
    plt.title('#=100000, bin=30, Energy=3 ')
    n, bins, patches = plt.hist(random_End_Energy(Energy,100000), 30, density=False, facecolor='g', alpha=0.75)
    plt.savefig('3MeV_2.png')
def histo4(Energy):
    plt.xlabel('Energie')
    plt.ylabel('Anzahl')
    plt.title('#=100000, bin=30, Energy=2.9 ')
    plt.grid(True)
    n, bins, patches = plt.hist(random_End_Energy(Energy,100000), 30, density=False, facecolor='g', alpha=0.75)
